...
namespace VentaAutos
{
    ...
    public partial class ActualizarVendAgencEdp
    {
        ...
        private void ActualizarVendAgencEdp_Load(object sender, EventArgs e)
        {
            ...
            int id = My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (My.MyProject.Forms.VendedorAgenciaEstados.eleccion == 1)
            {
                ...
                {
                    cmd = new SqlCommand();
                    cmd.Parameters.Add("@idvendedor", SqlDbType.Int).Value = My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    ...
                    query = "select fechamodifica from vendedor where id =" + My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    dt = Connection.SelectQuery(query);
            ...
            else if (My.MyProject.Forms.VendedorAgenciaEstados.eleccion == 2)
            {
                ...
                {
                    cmd = new SqlCommand();
                    cmd.Parameters.Add("@idagencia", SqlDbType.Int).Value = My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    cmd.Parameters.Add("@idusuariomodifica", SqlDbType.Int).Value = My.MyProject.Forms.InicioSeccion.idusuario;
                    cmd.Parameters.Add("@fechamodifica", SqlDbType.DateTime).Value = DateTime.Now;
                    cmd.Parameters.Add("@nombre", SqlDbType.VarChar).Value = txtactualiza.Text;
                    ...
                    query = "select fechamodifica from agencia where id =" + My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    dt = Connection.SelectQuery(query);
                    string comprobacion = Conversions.ToString(dt.AsEnumerable().ElementAtOrDefault(0)[0]);
            ...
            else if (My.MyProject.Forms.VendedorAgenciaEstados.eleccion == 3)
            {
                ...
                {
                    cmd = new SqlCommand();
                    cmd.Parameters.Add("@idEstado", SqlDbType.Int).Value = My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    cmd.Parameters.Add("@idusuariomodifica", SqlDbType.Int).Value = My.MyProject.Forms.InicioSeccion.idusuario;
                    cmd.Parameters.Add("@fechamodifica", SqlDbType.DateTime).Value = DateTime.Now;
                    cmd.Parameters.Add("@nombre", SqlDbType.VarChar).Value = txtactualiza.Text;
                    ...
                    query = "select fechamodifica from estado where id =" + My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    dt = Connection.SelectQuery(query);
                    string comprobacion = Conversions.ToString(dt.AsEnumerable().ElementAtOrDefault(0)[0]);
            ...
            else if (My.MyProject.Forms.VendedorAgenciaEstados.eleccion == 4)
            {
                ...
                {
                    cmd = new SqlCommand();
                    cmd.Parameters.Add("@idcarroceria", SqlDbType.Int).Value = My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    cmd.Parameters.Add("@idusuariomodifica", SqlDbType.Int).Value = My.MyProject.Forms.InicioSeccion.idusuario;
                    cmd.Parameters.Add("@fechamodifica", SqlDbType.DateTime).Value = DateTime.Now;
                    cmd.Parameters.Add("@nombre", SqlDbType.VarChar).Value = txtactualiza.Text;
                    ...
                    query = "select fechamodifica from carroceria where id =" + My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    dt = Connection.SelectQuery(query);
                    string comprobacion = Conversions.ToString(dt.AsEnumerable().ElementAtOrDefault(0)[0]);
            ...
            else if (My.MyProject.Forms.VendedorAgenciaEstados.eleccion == 5)
            {
                ...
                {
                    cmd = new SqlCommand();
                    cmd.Parameters.Add("@idmodelo", SqlDbType.Int).Value = My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    cmd.Parameters.Add("@idusuariomodifica", SqlDbType.Int).Value = My.MyProject.Forms.InicioSeccion.idusuario;
                    cmd.Parameters.Add("@fechamodifica", SqlDbType.DateTime).Value = DateTime.Now;
                    cmd.Parameters.Add("@nombre", SqlDbType.VarChar).Value = txtactualiza.Text;
                    ...
                    query = "select fechamodifica from modelo where id =" + My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    dt = Connection.SelectQuery(query);
                    string comprobacion = Conversions.ToString(dt.AsEnumerable().ElementAtOrDefault(0)[0]);
            ...
            else if (My.MyProject.Forms.VendedorAgenciaEstados.eleccion == 6)
            {
                ...
                {
                    cmd = new SqlCommand();
                    cmd.Parameters.Add("@idvariante", SqlDbType.Int).Value = My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    cmd.Parameters.Add("@idusuariomodifica", SqlDbType.Int).Value = My.MyProject.Forms.InicioSeccion.idusuario;
                    cmd.Parameters.Add("@fechamodifica", SqlDbType.DateTime).Value = DateTime.Now;
                    cmd.Parameters.Add("@nombre", SqlDbType.VarChar).Value = txtactualiza.Text;
                    ...
                    query = "select fechamodifica from variante where id =" + My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    dt = Connection.SelectQuery(query);
                    string comprobacion = Conversions.ToString(dt.AsEnumerable().ElementAtOrDefault(0)[0]);
            ...
            else if (My.MyProject.Forms.VendedorAgenciaEstados.eleccion == 7)
            {
                ...
                {
                    cmd = new SqlCommand();
                    cmd.Parameters.Add("@idTransmision", SqlDbType.Int).Value = My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    cmd.Parameters.Add("@idusuariomodifica", SqlDbType.Int).Value = My.MyProject.Forms.InicioSeccion.idusuario;
                    cmd.Parameters.Add("@fechamodifica", SqlDbType.DateTime).Value = DateTime.Now;
                    cmd.Parameters.Add("@nombre", SqlDbType.VarChar).Value = txtactualiza.Text;
                    ...
                    query = "select fechamodifica from trasmicion where id =" + My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    dt = Connection.SelectQuery(query);
                    string comprobacion = Conversions.ToString(dt.AsEnumerable().ElementAtOrDefault(0)[0]);
            ...
            else if (My.MyProject.Forms.VendedorAgenciaEstados.eleccion == 8)
            {
                ...
                {
                    cmd = new SqlCommand();
                    cmd.Parameters.Add("@idInterior", SqlDbType.Int).Value = My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    cmd.Parameters.Add("@idusuariomodifica", SqlDbType.Int).Value = My.MyProject.Forms.InicioSeccion.idusuario;
                    cmd.Parameters.Add("@fechamodifica", SqlDbType.DateTime).Value = DateTime.Now;
                    cmd.Parameters.Add("@nombre", SqlDbType.VarChar).Value = txtactualiza.Text;
                    ...
                    query = "select fechamodifica from interior where id =" + My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    dt = Connection.SelectQuery(query);
                    string comprobacion = Conversions.ToString(dt.AsEnumerable().ElementAtOrDefault(0)[0]);
            ...
            else if (My.MyProject.Forms.VendedorAgenciaEstados.eleccion == 9)
            {
                ...
                {
                    cmd = new SqlCommand();
                    cmd.Parameters.Add("@idcolor", SqlDbType.Int).Value = My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    cmd.Parameters.Add("@idusuariomodifica", SqlDbType.Int).Value = My.MyProject.Forms.InicioSeccion.idusuario;
                    cmd.Parameters.Add("@fechamodifica", SqlDbType.DateTime).Value = DateTime.Now;
                    cmd.Parameters.Add("@nombre", SqlDbType.VarChar).Value = txtactualiza.Text;
                    ...
                    query = "select fechamodifica from colores where id =" + My.MyProject.Forms.VendedorAgenciaEstados.EliminarActualizar;
                    dt = Connection.SelectQuery(query);
                    string comprobacion = Conversions.ToString(dt.AsEnumerable().ElementAtOrDefault(0)[0]);
